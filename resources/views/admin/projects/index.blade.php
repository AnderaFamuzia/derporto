<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex-col">
                <a href="{{ route('admin.projects.create') }}"
                    class="inline-block w-fit py-4 px-10 text-white bg-indigo-950 rounded-full font-bold hover:bg-indigo-900 transition">
                    Add new Project
                </a>
                <hr class="my-10">
